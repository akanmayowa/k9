                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.change') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-current" type="password" class="form-control @error('current-password') is-invalid @enderror" name="current_password" value="{{ $password_current ?? old('password_current') }}" required autocomplete="email" autofocus>
