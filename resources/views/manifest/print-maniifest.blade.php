                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-danger"><b>{{$waybill->departure_weight}} kg</b></td>
                            <td class="text-success"><b>{{$waybill->arrival_weight}} kg</b></td>
                        ...
                        {{--  --}}
                        @endforeach
                        <tr><td colspan="2"><b class="text-darker">Total Departure weight:</b> {{$total_arrival_weight}}</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
