...
<div class="card">
            ...
            <div class="card-header bg-dark border-0">
                <div class="row">
                  <div class="col-6">
                    <h3 class="mb-0"><span  style="color:white">ALL Bags</span></h3>
                  </div>
...
$("#bags-table").on('click', ".flag-destination-site", function(event){
...
$("#bags-table").on('click', ".view-details", function(event){
            event.preventDefault();
        ...
        $("#bags-table").on('click', ".view-destination-site", function(event){
            event.preventDefault();
